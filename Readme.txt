...
maxfilecontentlength= (number of characters to load from a file, adjust according to your context window)
maxwebcontentlength= (number of characters to load from a web page, adjust according to your context window)
