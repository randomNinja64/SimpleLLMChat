...
namespace SimpleLLMChatGUI
{
    public partial class Options : Window, INotifyPropertyChanged
    {
        ...
        private readonly List<string> _availableTools = new List<string> { "download_file", "download_video", "read_file", "read_website", "run_shell_command", "run_web_search", "write_file" };
